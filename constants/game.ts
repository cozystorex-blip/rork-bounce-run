...
export const GAME_CONFIG = {
  ...
  CALM_DURATION: 3,
  CRUISE_BOB_AMPLITUDE: 0.55,
  CRUISE_BOB_FREQUENCY: 0.038,
  CRUISE_MOMENTUM_DAMPING: 0.982,
  CRUISE_AUTO_GLIDE: 0.12,
  CRUISE_TAP_SOFTNESS: 0.88,
  CRUISE_DRIFT_SMOOTHING: 0.94,
  SQUEEZE_HITBOX_REDUCTION: 0.15,
  SQUEEZE_MAX_TIGHTNESS: 0.78,
  SQUEEZE_VISUAL_COMPRESS_X: 0.08,
  SQUEEZE_VISUAL_STRETCH_Y: 0.05,
  SQUEEZE_PROXIMITY_RANGE: 4.0,
  SQUEEZE_RECOVERY_SPEED: 0.88,
  AIRFLOW_DURATION: 22,
  AIRFLOW_STREAK_COUNT: 4,
  AIRFLOW_WOBBLE_DAMPEN: 0.3,
  AIRFLOW_TRAIL_LENGTH: 28,
  AIRFLOW_LINEAR_BOOST: 0.15,
  AIRFLOW_ENTRY_SMOOTHING: 0.92,
};
