...
export const GAME_CONFIG = {
  ...
  FALL_DRAG: 0.968,
  CRUISE_OSCILLATION_AMP: 0.32,
  CRUISE_OSCILLATION_SPEED: 0.035,
  CRUISE_GRAVITY_SOFTENER: 0.88,
  CRUISE_TAP_SOFTNESS: 0.92,
  CRUISE_MOMENTUM_DECAY: 0.997,
  CRUISE_MOMENTUM_BUILD: 0.06,
  AIRFLOW_STREAK_COUNT: 3,
  AIRFLOW_DURATION: 22,
  AIRFLOW_WOBBLE_DAMPEN: 0.4,
  AIRFLOW_STREAMLINE_FACTOR: 0.035,
