...
export const GAME_CONFIG = {
  ...
  CALM_DURATION: 3,
  CRUISE_BOB_AMPLITUDE: 0.45,
  CRUISE_BOB_FREQUENCY: 0.045,
  CRUISE_MOMENTUM_DAMPING: 0.978,
  SQUEEZE_HITBOX_REDUCTION: 0.12,
  SQUEEZE_MAX_TIGHTNESS: 0.82,
  SQUEEZE_VISUAL_COMPRESS_X: 0.06,
  SQUEEZE_VISUAL_STRETCH_Y: 0.04,
  AIRFLOW_DURATION: 18,
  AIRFLOW_STREAK_COUNT: 3,
  AIRFLOW_WOBBLE_DAMPEN: 0.4,
};
