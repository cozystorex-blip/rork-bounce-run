...
export const GAME_CONFIG = {
  ...
  HIGH_SPEED_EDGE_GRACE: 3.0,
  HIGH_SPEED_EDGE_GRACE_MAX: 8.0,
  IN_GAP_ASSIST_RANGE: 1.2,
  IN_GAP_GRAVITY_DAMPEN: 0.91,
  IN_GAP_WOBBLE_DAMPEN: 0.78,
  IN_GAP_CENTERING_FORCE: 0.06,
  SQUEEZE_FORGIVENESS_VISUAL_THRESHOLD: 0.25,
  SQUEEZE_FORGIVE_SPEED_SCALE: 0.35,
  SQUEEZE_FORGIVE_MAX_GRACE: 4.0,
  IN_GAP_SPEED_CENTERING_BOOST: 0.03,
  IN_GAP_LINEAR_DAMPEN: 0.95,
  BOTTOM_POLE_HARD_LIMIT: 1.5,
  MAX_GAP_VERTICAL_SHIFT_RATIO: 0.55,
  MIN_GAP_VERTICAL_SHIFT_RATIO: 0.15,
};
