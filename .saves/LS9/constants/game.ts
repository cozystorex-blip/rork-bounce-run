...
export const GLIDE_CONFIG = {
  BOB_AMPLITUDE: 0.4,
  BOB_FREQUENCY: 0.045,
  MOMENTUM_DAMPING: 0.978,
  CRUISE_TAP_SOFTENER: 0.92,
} as const;
...
export const GALLOP_SPEED_CONFIG = {
  POLE_SPEED_KICK: 0.035,
  MAX_POLE_BONUS: 0.7,
  POLE_BONUS_DECAY: 0.9975,
  STREAK_BONUS: 0.012,
  CADENCE_WINDOW_MIN: 20,
  CADENCE_WINDOW_MAX: 150,
  MAX_STREAK: 12,
  MOMENTUM_PER_CLEAR: 0.18,
  MOMENTUM_MAX: 2.5,
  MOMENTUM_DECAY: 0.995,
  GALLOP_BOUNCE: -0.3,
  GALLOP_TIMER_FRAMES: 24,
} as const;
