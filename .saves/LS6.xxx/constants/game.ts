...
export const GAME_CONFIG = {
  ...
  IN_GAP_ASSIST_RANGE: 1.4,
  IN_GAP_GRAVITY_DAMPEN: 0.78,
  IN_GAP_WOBBLE_DAMPEN: 0.65,
  IN_GAP_CENTERING_FORCE: 0.08,
  SQUEEZE_FORGIVENESS_VISUAL_THRESHOLD: 0.25,
  SQUEEZE_FORGIVE_SPEED_SCALE: 0.35,
  SQUEEZE_FORGIVE_MAX_GRACE: 5.0,
  IN_GAP_SPEED_CENTERING_BOOST: 0.05,
  IN_GAP_LINEAR_DAMPEN: 0.95,
